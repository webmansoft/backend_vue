...
let odata = isDevelop ? { username: 'admin', password: '123456', code: '' } : { username: '', password: '', code: '' }
				...
				<a-form :model="form" @submit="handleSubmit">
					...
					>
						<a-input v-model="form.code" :placeholder="$t('sys.login.verifyCode')" size="large" allow-clear>
							...
							<template #append>
								<img :src="captcha" style="width: 120px; height: 36px; cursor: pointer" @click="refreshCaptcha"  alt="验证码"/>
							</template>
						</a-input>
					</a-form-item>
